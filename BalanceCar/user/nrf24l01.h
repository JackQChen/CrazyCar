...
#define Set_NRF24L01_CE 	(GPIOB->BSRR = GPIO_Pin_15)    		// PB6
#define Clr_NRF24L01_CE  	(GPIOB->BRR = GPIO_Pin_15)    		// PB6
#define READ_NRF24L01_IRQ   (GPIOA->IDR&GPIO_Pin_8)			//IRQ主机数据输入 PB7
