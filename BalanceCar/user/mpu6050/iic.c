...
void iic_init(void)
{
	...
	I2C_InitStructure.I2C_ClockSpeed = 200000;  //300K
...
//	u8 errorflag = 1;
	...
	while(i--)
	{
		...
		/* 发送器件地址(写)*/
		I2C_Send7bitAddress(I2C2, SlaveAddres, I2C_Direction_Transmitter);
...
//			errorflag = 0;                     
		...
		else
		{
			...
			/* 发送器件地址(写)*/
			I2C_Send7bitAddress(I2C2, SlaveAddres, I2C_Direction_Receiver);
